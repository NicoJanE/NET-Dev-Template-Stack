...
This is the  **.NET 8 development Docker Environment*** with **11 ready-to-use project templates** for rapid application development within Docker<sup>*1</sup> and Visual Studio Code.  

<sub style="margin-left=24px;">*1. Building under Windows is supported when your local Window  environment is configured for it. </sub></span>
